...
const Checkout = () => {
  ...
  const onSubmit = async (data) => {
    ...
    data.currentday = moment().date().toString().padStart(2, '0'),
    data.currentmonth = (moment().month() + 1).toString().padStart(2, '0'),
    data.currentyear = moment().year().toString(),
    ...
    const payload = {
      ...
      email: watch("email"),
      fullName: watch("bName"),
      cccd: watch("bcccd"),
      birthday: watch("bBirthday"),
      address: watch("bAddress")
    }
